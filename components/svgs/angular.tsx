...
export default function Angular(props: any) {
    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 250 250" {...props}>
            <g>
                ...
                L125,52.1z M142,135.4H108l17-40.9L142,135.4z" fill="#ffffff"/>
            </g>
        </svg>
    )
}