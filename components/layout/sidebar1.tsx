    ...
    return (
        <aside className="h-full fixed z-20">
            ...
            ${sidebarOpen ? "w-52" : "w-20"}`}>
                <div className="flex justify-between items-center w-full px-3 py-7">
                    <div className="flex items-center">
                        <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
                        </svg>
                        <span className="ml-2 text-sm font-bold">App Name</span>
                    </div>
                    <div className="cursor-pointer mr-2" onClick={() => setSidebarOpen(!sidebarOpen)}>
                        <Image src={`/icons/chevron-${sidebarOpen ? "left" : "right"}.svg`} width={15} height={24} alt="toggle" />
                    </div>
                </div>
                <div className="w-full px-3">
                    <div className="flex flex-col items-center w-full border-t border-gray-700">
                        <a className="flex items-center w-full h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
                        ...
                        <a className="flex items-center w-full h-12 mt-2 text-gray-200 bg-gray-700 rounded" href="#">
                            <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
                        ...
                        <a className="relative flex items-center w-full h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
                            <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
